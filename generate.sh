...
openscad -D part=14 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-A-base.png deck_box.scad
openscad -D part=15 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-B-top.png deck_box.scad
openscad -D part=16 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-C-panels-racks.png deck_box.scad
openscad -D part=17 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-D-lowerhinges.png deck_box.scad
openscad -D part=18 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-E-mechanism.png deck_box.scad
openscad -D part=19 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-F-upperhinges.png deck_box.scad
openscad -D part=20 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,200 --imgsize=500,300 --render -o img/plate-G-platform.png deck_box.scad
...
openscad -D part=13 -D circleRes=120 -D j=0.1 --camera=0,0,0,55,0,330,150 --imgsize=500,300 --render -o img/part-tray-1x.png deck_box.scad
...
openscad -D part=18 -D circleRes=120 -D j=0.1 -D left_logo=\"manablue\" -D right_logo=\"manablack\" -o stl/logo_sample-2.stl deck_box.scad

# Slice plated layouts
slic3r -load slic3r.ini --output gcode/plate-A-base.gcode stl/plate-A-base.stl
slic3r -load slic3r.ini --output gcode/plate-B-top.gcode stl/plate-B-top.stl
slic3r -load slic3r.ini --output gcode/plate-C-panels_racks.gcode stl/plate-C-panels_racks.stl
slic3r -load slic3r.ini --output gcode/plate-D-lowerhinges.gcode stl/plate-D-lowerhinges.stl
slic3r -load slic3r.ini --output gcode/plate-E-mechanism.gcode stl/plate-E-mechanism.stl
slic3r -load slic3r.ini --output gcode/plate-F-upperhinges.gcode stl/plate-F-upperhinges.stl
slic3r -load slic3r.ini --output gcode/plate-G-platform.gcode stl/plate-G-platform.stl

# Slice individual parts
slic3r -load slic3r.ini --output gcode/part-front-1x.gcode stl/part-front-1x.stl
slic3r -load slic3r.ini --output gcode/part-back-1x.gcode stl/part-back-1x.stl
slic3r -load slic3r.ini --output gcode/part-left-1x.gcode stl/part-left-1x.stl
slic3r -load slic3r.ini --output gcode/part-right-1x.gcode stl/part-right-1x.stl
slic3r -load slic3r.ini --output gcode/part-racklift-2x.gcode stl/part-racklift-2x.stl
slic3r -load slic3r.ini --output gcode/part-corner_right-2x.gcode stl/part-corner_right-2x.stl
slic3r -load slic3r.ini --output gcode/part-corner_left-2x.gcode stl/part-corner_left-2x.stl
slic3r -load slic3r.ini --output gcode/part-mechanism-2x.gcode stl/part-mechanism-2x.stl
slic3r -load slic3r.ini --output gcode/part-lid-2x.gcode stl/part-lid-2x.stl
slic3r -load slic3r.ini --output gcode/part-topside-2x.gcode stl/part-topside-2x.stl
slic3r -load slic3r.ini --output gcode/part-rackliftplatform-1x.gcode stl/part-rackliftplatform-1x.stl
slic3r -load slic3r.ini --output gcode/part-tray-1x.gcode stl/part-base-1x.stl
slic3r -load slic3r.ini --output gcode/part-base-1x.gcode stl/part-base-1x.stl
