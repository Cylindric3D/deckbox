...
openscad -D part=11 -D circleRes=120 -D j=0.1 -o stl\deck_box-plate_A-base.stl deck_box.scad
openscad -D part=12 -D circleRes=120 -D j=0.1 -o stl\deck_box-plate_B-top.stl deck_box.scad
openscad -D part=13 -D circleRes=120 -D j=0.1 -o stl\deck_box-plate_C-panelracks.stl deck_box.scad
openscad -D part=14 -D circleRes=120 -D j=0.1 -o stl\deck_box-plate_D-lowerhinges.stl deck_box.scad
openscad -D part=15 -D circleRes=120 -D j=0.1 -o stl\deck_box-plate_E-mechanism.stl deck_box.scad
